...
{
    public class Game2D : MonoBehaviour, IBackgammonGame
    {
        ...
        public void ConfigureContextAndInit(bool continueProOrAI = true)
        {
            ...
            _analysisUI.Init();
            _analysisUI.SetToAILayout(Main.Instance.IfPlayerVsAI, Context.SelectedMatch, Context.IfPlayingAsPlayer1);
