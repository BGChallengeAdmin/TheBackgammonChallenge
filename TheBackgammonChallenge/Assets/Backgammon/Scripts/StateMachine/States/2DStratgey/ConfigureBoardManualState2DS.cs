...
{
    public class ConfigureBoardManualState2DS : GameState2DStrategy
    {
        public ConfigureBoardManualState2DS(GameStateContext2DStrategy context, GameStateMachine2DStrategy.EGameState2DStrategy estate) : base(context, estate) { }

        public override void EnterState()
        {
            Context.GameConfig.Debug_reportState.DebugMessage($"ENTER STATE: CONFIGURE BOARD MANUAL");
        ...
        public override void UpdateState()
        {
            ...
            if (Context.PointsManager.ManualSetupPointSelected)
            {
                ...
                if (TestIfCountersLeftToPlace())
                {
                    ...
                    _counterToPlace.SetCounterToMoveToPosition(Context.PointsManager.GetAdjustedPointPosition(point), Context.GameConfig.IfPlayerIsBlack);
        ...
        private void ResetAllPointsAndCounters()
        {
            ...
            _playerCounters = Context.GameConfig.IfPlayerIsBlack ? Context.CountersManager.BlackCounters :
            ...
            _opponentCounters = !Context.GameConfig.IfPlayerIsBlack ? Context.CountersManager.BlackCounters :
                                                              Context.CountersManager.WhiteCounters;
